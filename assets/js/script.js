import {fetchAllPokemon, writePokemon} from 'pokemonApiFunctions';
...
$("#cards").on("mouseup", ".card", function(){ //saves the new order of the deck after rearrangements
    setTimeout(saveReorderedDeck, 250); //250ms delay allows JQuery to finish rearranging in order to avoid null placeholder values
})
